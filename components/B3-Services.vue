<template>
	<section class="bg-gray-50 dark:bg-gray-800">
		<div
			class="mx-auto max-w-screen-xl px-4 py-8 flex-col items-center lg:px-6 lg:py-24 xl:gap-24">
			<div class="mx-auto mb-8 max-w-screen-md text-center lg:mb-12">
				...
				<p class="pb-6 border-b border-gray-100 dark:border-gray-700 font-light text-gray-500 dark:text-gray-400 sm:text-xl">
					Alles für Ihre erfolgreiche Online-Präsenz
				</p>
			</div>

			<div
				class="flex md:gap-12 md:space-y-0">
				<div>
					<svg
						class="mb-2 h-10 text-blue-600 dark:text-blue-500 md:h-12 md:w-12"
						fill="currentColor"
						viewBox="0 0 20 20"
					...
					<h3 class="mb-2 text-2xl font-bold dark:text-white">Analyse</h3>
				...
				<div>
					...
					<h3 class="mb-2 text-2xl font-bold dark:text-white">Design</h3>
					<p class="font-light text-gray-500 dark:text-gray-400">
				...
				<div>
					...
					<p class="font-light text-gray-500 dark:text-gray-400">
						Lorem ipsum dolor sit amet consectetur adipisicing elit. Dolorem tempore nam omnis?
					</p>
				</div>
				<div class="">
					<svg
					...
					<h3 class="mb-2 text-2xl font-bold dark:text-white">Weiterentwicklung</h3>
					<p class="font-light text-gray-500 dark:text-gray-400">
