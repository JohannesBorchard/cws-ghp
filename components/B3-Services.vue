<template>
	<section class="bg-gray-50 dark:bg-gray-800">
		<div
			class="mx-auto max-w-screen-xl flex-col items-center px-4 py-8 lg:px-6 lg:py-24 xl:gap-24">
			<div class="mx-auto mb-8 max-w-screen-md text-center lg:mb-12">
				...
				<p
					class="border-b border-gray-100 pb-6 font-light text-gray-500 dark:border-gray-700 dark:text-gray-400 sm:text-xl">
			...
			<div class="grid grid-cols-1 sm:grid-cols-2 gap-6 lg:grid-cols-4 md:gap-2 md:space-y-0 ">
				...
				<div>
					...
					<h3 class="mb-2 text-2xl font-bold dark:text-white">Umsetzung</h3>
					<p class="font-light text-gray-500 dark:text-gray-400">
